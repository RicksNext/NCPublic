...
!userInURL ? user = "geeken" : user = userInURL;
...
function loadDataFirstTime() {
            ...
            if (dataa.error) {
                ...
                if(dataa.success == false) {
                    ...
                    new Odometer({
                        ...
                        value: dataa.followers / 2,
                        format: '(,ddd).dd',
                    });
                    new Odometer({
                        el: document.getElementById("firstSmallOdo"),
                        value: dataa.watching_now,
                        format: '(,ddd).dd',
                    });
                    ...
                    setInterval(function () {
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                updateCounts.first(data.watching_now);
    ...
    $.ajax(`https://statsapi.nextcounts.com/brimeuser/${user}`)
        .done(function (stats) {
