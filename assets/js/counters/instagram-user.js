...
!userInURL ? user = "instagram" : user = userInURL;
...
function loadDataFirstTime() {
    $.ajax({
        url: `https://api-v2.nextcounts.com/api/instagram/user/${user}`,
        type: "GET",
        dataType: "JSON",
        success: function (data) {
            if (data.error) {
                ...
                $('#largeEmbedBtn')[0].href = `https://nextcounts.com/embed/large/?p=instagramuser&u=${user}`;
                ...
                setInterval(function () {
                    $.ajax({
                        url: `https://api-v2.nextcounts.com/api/instagram/user/stats/${data.id}`,
                        type: "GET",
                        dataType: "JSON",
