...
function loadDataFirstTime() {
    $.ajax({
        ...
        success: function (data) {
            if (data.success == false) {
                ...
                $('#openExternalBtn')[0].href = `https://storyfire.com/video-details?_id=${user}`;

                let samplePhrase = `NextCounts Live StoryFire Video Views Count for '${data.title}'!`;
    ...
    $.ajax(`https://api-v2.nextcounts.com/api/stats/storyfirevideo/${user}`)
        .done(function (ndata) {
