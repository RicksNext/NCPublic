    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.error) {
                ...
                $("#userbrand-navbar")[0].innerHTML = `<a class="navbar-brand"><img class="rounded-circle img-fluid" id="userimg-header" src="${data.pfp.large}" style="height: 50px;margin-right: 5px;" /> ${data.username}</a>`
