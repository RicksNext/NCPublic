...
const socialColor = 'rgb(25, 109, 74)';
const maxPoints = 900;
...
function loadDataFirstTime() {
    $.ajax({
        url: `https://api.nextcounts.com/api/teamtrees`,
        type: "GET",
        dataType: "JSON",
        success: function (data) {
            if (data.error || !data) {
                ...
                updateCounts.mainCount(Math.abs(data.trees));
                updateCounts.goalCount(Math.abs(data.trees));
