...
const userInURL = urlParams.get('v');
...
function searchForUser() {
    ...
    $.ajax({
        url: `https://api.nextcounts.com/api/utreon/video/search/${username}`,
        type: "GET",
        dataType: "JSON",
...
function loadDataFirstTime() {
    ...
    $.ajax({
        url: `https://api.nextcounts.com/api/utreon/video/${user}`,
        type: "GET",
        dataType: "JSON",
        success: function(data){
            if(data.error) {
                ...
                updateCounts.upvotes(data.upvotes);
                updateCounts.downvotes(data.downvotes);
                updateCounts.followers(data.uploader.followers);
...
var updateCounts = {
    ...
    upvotes: function(count) {
        document.getElementById('upvotesOdo').innerHTML = count;
    },
    downvotes: function(count) {
        document.getElementById('downvotesOdo').innerHTML = count;
    },
